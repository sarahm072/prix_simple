...
// جلب المنتجات من فئة السماعات
$sql = "SELECT * FROM products WHERE category = 'earphones'";
...
<head>
  <meta charset="UTF-8" />
  <title>سماعات - السعر البسيط</title>
...
<form method="GET" style="text-align: center; margin-bottom: 30px;">
  ...
  <a href="earphones.php" style="margin-right: 15px; color: #070707ff; text-decoration:none;">🔄 إعادة تعيين</a>
  ...
  <div class="product-grid">
    ...
    if ($result && $result->num_rows > 0) {
      ...
      echo "<p style='text-align:center;'>لا توجد منتجات حالياً في فئة السماعات.</p>";
    }
