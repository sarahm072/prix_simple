...
$sql = "SELECT * FROM products WHERE category = 'tablets'";
...
<head>
  <meta charset="UTF-8" />
  <title>لوحات إلكترونية - السعر البسيط</title>
...
<section class="products">
  <h1>📟 لوحات إلكترونية</h1>
<p style="text-align: center; font-size: 18px; margin-bottom: 15px;">
🔍 يمكنك البحث عن الالواح الالكترونية حسب <strong>الاسم أو الماركة</strong>، وتحديد <strong>ميزانيتك</strong> لاختيار ما يناسبك.
</p>
...
<form method="GET" style="text-align: center; margin-bottom: 30px;">
  ...
  <a href="tablets.php" style="margin-right: 15px; color: #007BFF; text-decoration: underline;">🔄 إعادة تعيين</a>
</form>
  ...
  <div class="product-grid">
    ...
    if ($result && $result->num_rows > 0) {
      ...
      echo "<p style='text-align:center;'>لا توجد منتجات حالياً في هذه الفئة.</p>";
    }
