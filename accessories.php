...
// جلب المنتجات من فئة accessories
...
<head>
  <meta charset="UTF-8" />
  <title>الاكسسوارات - السعر البسيط</title>
  <style>
    body {
      margin: 0;
...
<form method="GET" style="text-align: center; margin-bottom: 30px;">
  ...
  <a href="accessoires.php" style="margin-right: 15px; color: #070707ff; text-decoration:none;">🔄 إعادة تعيين</a>
  ...
  <div class="product-grid">
    ...
    if ($result && $result->num_rows > 0) {
      ...
      echo "<p style='text-align:center;'>لا توجد منتجات حالياً في فئة الإكسسوارات.</p>";
    }
